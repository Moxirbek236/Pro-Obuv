...
class Config:
    ...
    if not DATABASE_URL:
        # Fallback to local development PostgreSQL if DATABASE_URL is missing
        # but in production, this should always be provided.
    ...
    SQLALCHEMY_ENGINE_OPTIONS = {
        "pool_size": int(os.environ.get("DB_POOL_MAX_CONNECTIONS", "20")),
        "pool_timeout": 30,
        "pool_recycle": 3600,
        "pool_pre_ping": True,
        "max_overflow": 10,
    ...
    CLIENT_URLS = [
        "http://localhost:3000",
        "http://127.0.0.1:3000",
        "https://safetyuz.netlify.app",
        "https://pro-obuv.onrender.com"
    ]
